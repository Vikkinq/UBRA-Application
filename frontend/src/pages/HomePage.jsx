...
export default function HomePage() {
  ...
  return (
    <div className="flex min-h-screen bg-[#ffffff] text-[#004030]">
      {/* Sidebar */}
      <Sidebar />
      ...
      <main className="flex-1 overflow-y-auto px-8 py-6">
        ...
        <header className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <button className="flex items-center gap-2 bg-[#4A9782] text-white px-4 py-2 rounded-lg hover:bg-[#3c836e] transition">
